...
import kennel.storage.KennelStorage;
import kennel.view.ConsoleView;
import kennel.view.View;
        ...
        while (true) {
            ...
            switch (code) {
                ...
                case REMOVE_ANIMAL:
                    ...
                    String resMessage1 = removeId > -1  ? "Выписано животное" + removeId : "Не удалось  выписать животное";
