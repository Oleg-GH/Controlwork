...
import kennel.controller.KennelAccounting;
import kennel.model.AbstractAnimal;
import kennel.model.AnimalGenius;
import kennel.model.Skill;
import kennel.util.Counter;
import kennel.view.AnimalData;
...
public class ConsoleView implements View {
    ...
    public boolean showAddAnimalDialog() {
        ...
        while (true) {
            ...
            try (counter){
                ...
                counter.add();
                return kennelAccounting.createAnimal(parsedData.getName(), parsedData.getBirthDate(), parsedData.getAnimalGenius());
    ...
    private void printRegistryHeader() {
        String header = String.format(COLUMN_HEADER_FORMAT, "№", "Кличка", "Дата рождения", "Возраст(мес)",
                "Род животного");
    ...
    private void printAnimalInfo(AbstractAnimal animal) {
        ...
        System.out.printf("Возраст (мес): %d\n", animal.getAge());
